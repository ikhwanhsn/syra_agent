        ...
        <DialogContent className="post-share-modal border-white/10 bg-[#0a0a0a] text-white sm:max-w-lg">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
            ...
            <button
              type="button"
              onClick={handleCopy}
              className="inline-flex h-10 items-center justify-center gap-2 rounded-full border border-primary/30 bg-primary/15 px-5 font-mono text-[10px] uppercase tracking-[0.12em] text-primary transition-colors hover:bg-primary/25"
            >
