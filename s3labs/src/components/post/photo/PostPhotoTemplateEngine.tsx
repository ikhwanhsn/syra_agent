    ...
    case "logo-lockup":
      return (
        <div key={block} className="post-photo-cover-lockup">
          <img src="/images/logo.png" alt="" className="post-photo-cover-logo" />
      ...
      return (
        <div key={block} className="post-photo-terminal-wrap">
          <div className="post-photo-terminal-bar">
            ...
            <span className="post-photo-terminal-dot" />
            <span className="post-photo-terminal-dot" />
            <span className="post-photo-terminal-title">S3 Labs · signal</span>
          </div>
...
export function renderPostPhotoTemplate(
  ...
  const bgVariant = role ? getPostPhotoBgVariant(role) : "ribbon";
