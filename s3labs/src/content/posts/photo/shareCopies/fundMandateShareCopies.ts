...
S3 Labs: onchain capital for high conviction bets on Solana. Published 80/20 mandate. On-chain verification before every position.
...
That's not marketing copy — it's the allocation gate. Every position passes onchain verification first.`,
  ...
  flow: `How S3 Labs allocates — four steps:
...
The gap between "trust us" and "verify us" is exactly what we're closing.`,
  ...
  launch: `LIVE — S3 Labs mandate is public.
