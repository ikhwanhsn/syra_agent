export const KOL_CREATE_CAMPAIGN_TOOLTIP =
  "Create and fund one campaign on S3 Labs to unlock this reward. Pending deposits do not count. If this campaign ends first, the reward is forfeited.";

export const KOL_CREATE_CAMPAIGN_OWN_NOTE =
  "Create and fund one campaign before this ends — pending deposits do not count. Otherwise your reward is forfeited.";
...
export const KOL_CREATE_CAMPAIGN_NEXT_TIME_NOTE =
  "Create and fund a campaign before your next one so you qualify for rewards.";
