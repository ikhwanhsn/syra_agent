...
# Memecoin Surviving Market Dumps API

Memecoins surviving market dumps with the x402 payment protocol.

## Overview

This API returns AI-researched memecoins that are surviving or holding up during market dumps. This is a paid API that uses the x402 payment protocol—you must complete payment before receiving the data.
...
### GET /v2/memecoin/surviving-market-dumps

Fetch memecoins surviving market dumps.

**Example Request:**

```bash
curl https://api.syraa.fun/v2/memecoin/surviving-market-dumps
```
...
### POST /v2/memecoin/surviving-market-dumps
...
```bash
curl -X POST https://api.syraa.fun/v2/memecoin/surviving-market-dumps \
