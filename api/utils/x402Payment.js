  ...
  return async (req, res, next) => {
    try {
      ...
      if (X402_VERSION === 2) {
        ...
        try {
          console.log("Creating V2 payment requirements...");
          ...
          console.log(
            "V2 Payment requirements created:",
          ...
          console.log(
            "Manual V2 payment requirements:",
            JSON.stringify(paymentRequirements, null, 2),
          );
        }
      ...
      try {
        console.log(
          "Verifying payment with requirements:",
          JSON.stringify(paymentRequirements, null, 2),
        );
        ...
        return res.status(402).json({
          ...x402ResponseTemplate,
          error: `Payment verification failed: ${verifyError.message || "Facilitator rejected the payment (403)"}`,
        });
      }
