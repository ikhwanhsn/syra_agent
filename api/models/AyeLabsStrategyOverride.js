/**
 * Runtime strategy definitions for the AyeLabs experiment desk.
 * Base rows live in config; evolution overwrites specific strategyId slots via upserts here.
 */
import mongoose from "mongoose";

const ayelabsStrategyOverrideSchema = new mongoose.Schema(
  {
  ...
  { timestamps: true, collection: "ayelabs_strategy_overrides" },
);

const AyeLabsStrategyOverride =
  mongoose.models.AyeLabsStrategyOverride ||
  mongoose.model("AyeLabsStrategyOverride", ayelabsStrategyOverrideSchema);

export default AyeLabsStrategyOverride;
