...
export function getX402SmokeProbes() {
  ...
  const probes = [
    ...
    { id: "health_get", method: "GET", path: "/health" },
    { id: "health_post", method: "POST", path: "/health", body: {} },
    { id: "mpp_health_get", method: "GET", path: "/mpp/health" },
    { id: "mpp_health_post", method: "POST", path: "/mpp/health", body: {} },
    { id: "web_search_get", method: "GET", path: "/web-search", query: "query=test" },
    { id: "web_search_post", method: "POST", path: "/web-search", body: { query: "test" } },
    ...
    { id: "jupiter_quote_get", method: "GET", path: "/jupiter/quote", query: "inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=10000000" },
    { id: "jupiter_quote_post", method: "POST", path: "/jupiter/quote", body: { inputMint: "So11111111111111111111111111111111111111112", outputMint: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", amount: "10000000" } },
    { id: "pumpfun_trending_get", method: "GET", path: "/pumpfun/trending", query: "limit=10&offset=0&includeNsfw=false" },
    { id: "pumpfun_movers_get", method: "GET", path: "/pumpfun/movers", query: "limit=10&offset=0&includeNsfw=false" },
    {
      id: "pumpfun_analyzer_get",
      method: "GET",
      path: "/pumpfun/analyzer",
      query: "mint=8a3sEw2kizHxVnT9oLEVLADx8fTMPkjbEGSraqNWpump",
    },
    { id: "assets_get", method: "GET", path: "/assets", query: "list=all&assetClass=all&sort=marketCap&order=desc&limit=10&offset=0" },
    { id: "assets_detail_get", method: "GET", path: "/assets/detail", query: "ref=btc" },
    { id: "bitcoin_get", method: "GET", path: "/bitcoin", query: "exchange=binance&interval=1h&limit=200" },
    ...
    { id: "pumpfun_sol_price", method: "GET", path: "/pumpfun/sol-price" },
    {
      id: "pumpfun_coin",
      method: "GET",
      path: "/pumpfun/coin/8a3sEw2kizHxVnT9oLEVLADx8fTMPkjbEGSraqNWpump",
    },
    {
      id: "pumpfun_coin_query",
      method: "GET",
      path: "/pumpfun/coin",
      query: "mint=8a3sEw2kizHxVnT9oLEVLADx8fTMPkjbEGSraqNWpump",
    },
    { id: "pumpfun_swap_post", method: "POST", path: "/pumpfun/agents/swap", body: {} },
    { id: "pumpfun_create_post", method: "POST", path: "/pumpfun/agents/create-coin", body: {} },
    { id: "pumpfun_collect_fees_post", method: "POST", path: "/pumpfun/agents/collect-fees", body: {} },
    { id: "pumpfun_sharing_post", method: "POST", path: "/pumpfun/agents/sharing-config", body: {} },
    { id: "pumpfun_agent_build_post", method: "POST", path: "/pumpfun/agent-payments/build-accept", body: {} },
    { id: "pumpfun_agent_verify_post", method: "POST", path: "/pumpfun/agent-payments/verify", body: {} },
    ...nansenProbes(),
    ...heylolProbes(),
  ];
  return probes;
