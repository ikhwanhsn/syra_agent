...
export const AGENT_TOOLS = [
  ...
  {
    id: 'dexscreener-pairs',
    agentDirect: false,
    path: '/dexscreener/pairs',
    method: 'GET',
    priceUsd: X402_API_PRICE_DEXSCREENER_PAIRS_USD,
    displayPriceUsd: X402_DISPLAY_PRICE_DEXSCREENER_PAIRS_USD,
    name: 'DexScreener Pairs',
    description:
      'Onchain DEX pairs from DexScreener — chainId + tokenAddress OR q search. Returns price, liquidity, volume, txns.',
  },
  {
    id: 'geckoterminal-pools',
    agentDirect: false,
    path: '/geckoterminal/pools',
    method: 'GET',
    priceUsd: X402_API_PRICE_GECKOTERMINAL_POOLS_USD,
    displayPriceUsd: X402_DISPLAY_PRICE_GECKOTERMINAL_POOLS_USD,
    name: 'GeckoTerminal Pools',
    description:
      'Trending or new DEX pools from GeckoTerminal — network (default solana), kind=trending|new, limit.',
  },
  {
    id: 'defillama-tvl',
    agentDirect: false,
    path: '/defillama/tvl',
    method: 'GET',
    priceUsd: X402_API_PRICE_DEFILLAMA_TVL_USD,
    displayPriceUsd: X402_DISPLAY_PRICE_DEFILLAMA_TVL_USD,
    name: 'DefiLlama TVL',
    description:
  ...
  },
  {
    ...
    method: 'GET',
    priceUsd: X402_API_PRICE_RUGCHECK_REPORT_USD,
    displayPriceUsd: X402_DISPLAY_PRICE_RUGCHECK_REPORT_USD,
    name: 'RugCheck Token Report',
    description:
      'Solana token risk report from RugCheck — mint (required). Returns risk score, authorities, top holders.',
  },
  {
    id: 'pyth-price',
    agentDirect: false,
    path: '/pyth/price',
    method: 'GET',
    priceUsd: X402_API_PRICE_PYTH_PRICE_USD,
    displayPriceUsd: X402_DISPLAY_PRICE_PYTH_PRICE_USD,
