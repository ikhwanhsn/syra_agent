...
import { memecoinsMostMentionedBySmartMoneyX } from "../../prompts/memecoin.js";

export async function createMemecoinsMostMentionedBySmartMoneyXRouter() {
    ...
    router.get("/dev", async (_req, res) => {
      ...
      try {
        const result = await client.callTool({
          ...
          arguments: xLiveSearchService.getArguments({ query: memecoinsMostMentionedBySmartMoneyX }),
        });
  ...
  router.get(
    ...
    async (req, res) => {
      ...
      const searchParams = {
        query: memecoinsMostMentionedBySmartMoneyX,
      };
