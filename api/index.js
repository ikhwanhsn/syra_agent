...
import { createAgentDexscreenerTokensRouter } from "./routes/agent/dexscreenerTokens.js";
...
import { createAgentEconomyRouter } from "./routes/agentEconomy.js";
...
function isX402Route(p) {
  ...
  if (p === "/agent-economy" || p.startsWith("/agent-economy/")) return true;
...
app.use("/agent-economy", await createAgentEconomyRouter());
...
app.use("/agent/dexscreener", createAgentDexscreenerTokensRouter());
