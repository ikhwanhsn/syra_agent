...
export const AGENT_TOOLS_CATALOG: AgentToolCatalogEntry[] = [
  ...
  },
  {
    ...
    priceUsd: 0.02,
    examplePrompt: "Use Jupiter swap order: Jupiter Ultra swap order on Solana: returns a base64 transaction to sign",
    category: "core",
  },
  {
  ...
  },
  {
    ...
    priceUsd: 0.012,
    examplePrompt: "Use MevX: trades: Recent DEX trades from MevX (requires MEVX_API_KEY)",
    category: "core",
  },
  {
    id: "mevx-token",
    ...
    priceUsd: 0.012,
    examplePrompt: "Use MevX: token info: Token market info via MevX Data API (requires MEVX_API_KEY)",
    category: "core",
  },
  {
    id: "mevx-pools",
    ...
    priceUsd: 0.012,
    examplePrompt: "Use MevX: pools: Pool lookup via MevX Data API (requires MEVX_API_KEY)",
    category: "core",
  },
  {
    id: "smart-money",
  ...
  },
  {
    ...
    priceUsd: 0.001,
    examplePrompt: "Use GeckoTerminal Pools: Trending or new DEX pools from GeckoTerminal — network (default solana), kind=trending|new, limit",
    category: "core",
  },
  {
    id: "defillama-tvl",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use DefiLlama TVL: Protocol or chain TVL from DefiLlama — protocol slug (e",
    category: "core",
  },
  {
    id: "pyth-price",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use Pyth Oracle Prices: Real-time Pyth oracle prices via Hermes — symbols (comma-separated, e",
    category: "core",
  },
  {
    id: "flint-pairs",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use Flint Pairs: Flint Solana multi-maker spot pair catalog — base/quote mints, spot ids, last price",
    category: "core",
  },
  {
    id: "flint-book",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use Flint Order Book: Flint L1/L2/L3 virtual order book snapshot — base + quote (default USDC) or baseId/quoteId",
    category: "core",
  },
  {
    id: "flint-stats",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use Flint Venue Stats: Flint venue summary — active pairs/makers, 1h/24h/30d quote volume, fills, unique traders, total NAV",
    category: "core",
  },
  {
    id: "flint-candles",
    ...
    priceUsd: 0.001,
    examplePrompt: "Use Flint Candles / Fills: Flint historical candles (interval 1M|5M|15M|30M|1H|4H|1D) or kind=fills",
    category: "core",
  },
  {
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Flint External Tape: Short snapshot of external aggregator fills (Jupiter/OKX/DFlow/Titan) and venue reference quotes for a Flint pair",
    category: "core",
  },
  {
    id: "bubblemaps-maps",
  ...
  },
  {
    ...
    priceUsd: 0.0024,
    examplePrompt: "Use Blocksize: instrument search: Free discovery search for VWAP/bidask pairs (e",
    category: "core",
  },
  {
    id: "blocksize-vwap",
    ...
    priceUsd: 0.0024,
    examplePrompt: "Use Blocksize: crypto VWAP: Institutional real-time VWAP snapshot",
    category: "core",
  },
  {
    id: "blocksize-bidask",
    ...
    priceUsd: 0.0024,
    examplePrompt: "Use Blocksize: bid/ask: Bid/ask snapshot with spread",
    category: "core",
  },
  {
    ...
    priceUsd: 0.12,
    examplePrompt: "Use Blocksize: pre-trade sanity check: Quote freshness / spread / reference-drift guardrails (~$0",
    category: "core",
  },
  {
    id: "dexter-x402-catalog",
    name: "Dexter: x402 catalog",
    description: "Free list of Dexter paid resources from /.well-known/x402 (activity, entity, shield, …).",
    priceUsd: 0,
    examplePrompt: "Use Dexter: x402 catalog: Free list of Dexter paid resources from /",
    category: "core",
  },
  {
    id: "dexter-onchain-activity",
    ...
    priceUsd: 0.06,
    examplePrompt: "Use Dexter: onchain activity: Solana token/wallet trade summary with volumes and top counterparties (x402 ~$0",
    category: "core",
  },
  {
    id: "dexter-onchain-entity",
    ...
    priceUsd: 0.06,
    examplePrompt: "Use Dexter: onchain entity: Detailed entity insight (token/wallet/trade) with SOL/token deltas (x402 ~$0",
    category: "core",
  },
  {
  ...
  },
  {
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: find opportunities: Search 3,000+ onchain yield opportunities across 80+ networks (lending, vaults, staking, RWAs, LST)",
    category: "core",
  },
  {
    id: "yield-get",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: get opportunity: Full metadata for one yield: fees, lockup/cooldown, reward mechanics, entry/exit status, risk summary",
    category: "core",
  },
  {
    id: "yield-networks",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: list networks: List all networks supported by Yield",
    category: "core",
  },
  {
    id: "yield-providers",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: list providers: List yield protocols and validator providers (id, name, type, tvlUsd)",
    category: "core",
  },
  {
    id: "yield-risk",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: risk rating: Aggregate risk rating for a yield (letter grade, numeric score, provider URL)",
    category: "core",
  },
  {
    id: "yield-reward-history",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: reward-rate history: Historical APY / reward-rate snapshots for a yield",
    category: "core",
  },
  {
    id: "yield-tvl-history",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: TVL history: Historical TVL snapshots for a yield",
    category: "core",
  },
  {
    id: "yield-balances",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use Yield.xyz: wallet balances: Active positions, pending actions, and claimable rewards for a wallet on a network",
    category: "core",
  },
  ...
  },
  {
    ...
    priceUsd: 0.001,
    examplePrompt: "Use DexScreener Pairs: Onchain DEX pairs from DexScreener — chainId + tokenAddress OR q search",
    category: "memecoin",
  },
  {
    id: "rugcheck-report",
    ...
    priceUsd: 0.005,
    examplePrompt: "Use RugCheck Token Report: Solana token risk report from RugCheck — mint (required)",
    category: "memecoin",
  },
