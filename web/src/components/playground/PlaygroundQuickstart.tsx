  ...
  return (
    <div className={cn(PLAYGROUND_PAGE_CLASS, "space-y-6 sm:space-y-8")}>
      <PlaygroundHero
        ...
        title="Wire agents to Syra"
        description="Install MCP or the TypeScript SDK, point at api.syraa.fun, and settle USDC via x402 on each call. The Catalog tab is optional — preview routes in a browser when you need them."
        badges={
          <>
      ...
      <p className={cn("max-w-2xl text-sm leading-relaxed text-muted-foreground", playgroundSectionEnter)}>
        ...
        {" — "}
        Copy-paste paths for MCP hosts, typed agents, and raw x402 discovery.
      </p>
      ...
      >
        <p className="text-xs text-muted-foreground">
          Next: wire MCP or the SDK, fund USDC, and make a paid call — browse is for humans;
          agents should integrate.
        </p>
        <a
