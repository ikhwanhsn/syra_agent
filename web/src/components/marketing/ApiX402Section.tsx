...
import { LINK_PLAYGROUND, LINK_DOCS } from "@/lib/marketing/global";
          ...
          <div className="order-2 min-w-0 text-center md:order-1 md:text-left">
            ...
            >
              ...
              <p>
                ...
                <span className="text-foreground/90">syraa.fun/marketplace</span> (agent Integrate +
                optional Catalog preview) are ordinary sites you open in a browser—no API credentials
                in the page. Syra-owned frontends never ship API keys; the server injects auth for
