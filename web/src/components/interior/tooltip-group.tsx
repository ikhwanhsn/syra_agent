        ...
        <AnimatePresence>
          {open ? (
            <motion.span
              ...
              className={cn(
                "relative w-max max-w-[220px] shrink-0 overflow-hidden rounded-md px-2 py-1 text-[11.5px] font-medium leading-snug text-foreground",
                contentClassName,
              )}
            >
              <motion.span
                ...
                className="absolute inset-0 rounded-md border border-border bg-popover shadow-soft"
              />
              <motion.span
