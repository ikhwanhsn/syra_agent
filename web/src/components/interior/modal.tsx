      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              "relative flex w-full flex-col overflow-hidden rounded-lg border border-border bg-popover text-popover-foreground shadow-medium outline-none",
              className,
            )}
          >
            <div className="flex shrink-0 items-start gap-3 px-4 pb-3 pt-4">
              ...
              {showClose ? (
                <button
                  ...
                  className={cn(
                    "-mr-1 -mt-1 grid size-7 shrink-0 place-items-center rounded-md text-muted-foreground outline-none transition-colors duration-150",
