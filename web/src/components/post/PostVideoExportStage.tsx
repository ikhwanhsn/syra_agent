...
/** Off-screen 1920×1080 stage used for programmatic video export. */
export function PostVideoExportStage({ slides, slideIndex, exportRef }: PostVideoExportStageProps) {
  ...
  return (
    <div ref={setRootRef} className="post-video-export-root" aria-hidden>
      <div
        ...
        style={{ width: POST_VIDEO_WIDTH, height: POST_VIDEO_HEIGHT }}
      >
