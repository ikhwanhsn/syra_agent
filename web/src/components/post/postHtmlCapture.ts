...
/** Hide frame guides and freeze reveal motion for static captures (photo / share cards). */
export function setPostExportActive(active: boolean): void {
  ...
  document.querySelector(".post-photo-export-root")?.classList.toggle("post-export-active", active);
}
