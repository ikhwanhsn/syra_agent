          ...
          <div className="min-w-0 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-lg text-pretty text-[15px] leading-relaxed text-muted-foreground">
                Watch AI strategies paper-trade alpha runners and beta followers on live Pump.fun tape.
                Pick a style, compare returns, and learn what works before you risk real SOL.
              </p>
            </div>
          </div>
