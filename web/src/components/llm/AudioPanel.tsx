...
import { useLlmSpeech } from "@/hooks/useLlmPlayground";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Synthesize speech from text. Defaults to the cheapest TTS model.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Voices are provider-specific; OpenAI-style voices work with OpenAI TTS models.
          </p>
        </div>

        <Button type="button" onClick={() => void onSubmit()} disabled={speech.isPending}>
          {speech.isPending ? (
            <>
