/** Single source of truth for Syra product focus — the financial + intelligence rail. */

export const SYRA_TAGLINE = "Machine money for AI trading agents";

export const SYRA_USP =
  "The rail agents pay to think and trade on Solana — intelligence APIs + agent money layer.";

export const SYRA_ONE_LINER = "Stripe + Plaid for AI trading agents on Solana.";

export const SYRA_PROOF_FRAMING =
  "Powered by the Syra rail — live proof that autonomous agents earn, spend, and trade on Syra infrastructure.";
