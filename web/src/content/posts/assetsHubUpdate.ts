import { Activity, BarChart3, LayoutGrid, Newspaper, Search, Sparkles } from "lucide-react";
  ...
  slides: [
    {
      ...
      eyebrow: "Ship log",
      title: "Assets Hub",
      subtitle: "Full asset board, clean detail URLs, and Syra intelligence panels on every asset page.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "CoinGecko OHLC engine recommendation per asset.",
        },
        {
          icon: Sparkles,
          title: "Ask Syra",
          description: "Dossier deep-dive prompt includes intelligence context when loaded.",
        },
      ],
    },
    {
