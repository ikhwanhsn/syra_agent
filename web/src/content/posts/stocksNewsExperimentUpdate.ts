...
export const STOCKS_NEWS_EXPERIMENT_POST: PostUpdate = {
  meta: {
    ...
    shareCopyVideo: `SHIP LOG · Syra just shipped the Stocks News Lab.

15 AI trading agents compete on tokenized stocks (TSLAx, AAPLx, NVDAx, SPYx, SPCXx) using live headlines and Jupiter prices.

→ $1,000 paper bank per agent — no real trades
→ News + sentiment score each stock before entry
→ Leaderboard ranks the most profitable strategy
→ Daily evolution: losers removed, winners spawn smarter copies

Watch which news-driven agent wins. Learn before you risk capital.

Full walkthrough in the video ↓`,
    shareCopyPhoto: `NEW ON SYRA · Stocks News Lab.

15 agents paper-trade xStocks on Solana using headlines and Jupiter prices. $1,000 virtual bank each. Best agent rises on the leaderboard. Losers get culled daily.
...
→ syraa.fun/stocks`,
  ...
  slides: [
    ...
    },
    {
      ...
      label: "Context",
      kicker: "For traders",
      headline: "News moves stocks. Most traders react too late.",
      body: "Headlines hit, price jumps, and you are still reading the feed. Syra runs 15 autonomous agents that scan news and sentiment for TSLAx, AAPLx, NVDAx, SPYx, and SPCXx — then paper-trade on Jupiter prices so you can see what would have worked, with zero capital at risk.",
    },
    {
      id: "shipped",
      kind: "hero",
      ...
      headline: "A stock trading tournament on news",
    ...
    },
    {
      ...
      headline: "15 agents, 15 ways to trade news",
      cards: [
        {
          title: "News follower",
      ...
      items: [
        {
          icon: BarChart3,
          title: "Stocks News Lab",
          description: "Leaderboard, equity curve, recent trades, and live news feed driving entries.",
    ...
    },
    {
      ...
      headline: "Prove the edge before risking SOL",
      stats: [
      ...
      narrative:
        "Tokenized stocks on Solana trade like crypto: fast, 24/7, headline-driven. The Stocks News Lab lets you watch which news rules actually make money before you size a real position. Paper P&L is tracked in USD. Jupiter marks every entry and exit.",
    },
    {
      id: "closing",
      kind: "closing",
