...
export const AMPERSEND_MARKETPLACE_PHOTO_SHARE_COPIES: Record<PostPhotoCardRole, string> = {
  cover: `SHIP LOG · Syra x402 APIs are on the Ampersend marketplace.
...
Browse → app.ampersend.ai/discover`,

  flow: `How Syra lands on Ampersend:
...
→ Base as Ampersend production network
