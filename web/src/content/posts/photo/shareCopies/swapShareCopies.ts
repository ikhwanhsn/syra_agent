...
export const SWAP_PHOTO_SHARE_COPIES: Record<PostPhotoCardRole, string> = {
  cover: `Syra just shipped Jupiter Swap.
...
Built for production wallets.`,
  ...
  checklist: `Jupiter Swap — live now:
...
Earn → Swap on Syra. Same wallet. Jupiter prices. One dashboard.`,
  ...
  launch: `Syra × Jupiter Swap is live.
...
Staking locks for yield. Jupiter Swap for execution. Both under Earn in the navbar — pick the action, not the app.`,

  terminal: `$ curl syraa.fun/jupiter/ui/quote?inputMint=So11...&outputMint=EPjF...&amount=1000000
