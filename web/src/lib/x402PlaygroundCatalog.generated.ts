...
export const X402_PLAYGROUND_GENERATED_AT = "2026-08-01T03:15:39.068Z";
...
export const X402_PLAYGROUND_RESOURCE_TEMPLATES: X402PlaygroundResourceTemplate[] = [
  ...
  },
  {
    "segment": "flint/pairs",
    "id": "x402-flint-pairs",
    "label": "Flint Pairs: Flint Solana multi-maker spot pair catalog",
    "method": "GET",
    "params": [],
    "catalogMeta": {
      "segment": "flint/pairs",
      ...
      "description": "Listed pairs on Flint (multi-maker on-chain Solana spot DEX) with base/quote mints, spot ids, and last price when available. Use when an ag…",
      "priceUsd": "0.001",
      "category": "analytics"
    }
  },
  {
    "segment": "flint/book",
    "id": "x402-flint-book",
    "label": "Flint Order Book: Flint L1/L2/L3 virtual order book snapshot",
    "method": "GET",
    "params": [],
    "catalogMeta": {
      "segment": "flint/book",
      ...
      "description": "One-shot book snapshot from Flint MarketDataService (default L2). Use when an agent needs CLOB-style depth on Flint before sizing a trade e…",
      "priceUsd": "0.001",
      "category": "analytics"
    }
  },
  {
    "segment": "flint/stats",
    "id": "x402-flint-stats",
    "label": "Flint Venue Stats: Flint venue summary stats (volume, makers, NAV)",
    "method": "GET",
    "params": [],
    "catalogMeta": {
      "segment": "flint/stats",
      ...
      "description": "Cross-venue summary from Flint StatsService: active pairs/makers, 1h/24h/30d quote volume and fill counts, unique traders, total NAV. Use w…",
      "priceUsd": "0.001",
      "category": "analytics"
    }
  },
  {
    "segment": "flint/candles",
    "id": "x402-flint-candles",
    "label": "Flint Candles / Fills: Flint historical candles or public fills",
    "method": "GET",
    "params": [],
    "catalogMeta": {
      "segment": "flint/candles",
      ...
      "description": "HistoricalService candles (kind=candles, interval 1M|5M|15M|30M|1H|4H|1D) or public fills (kind=fills). Use when an agent needs Flint OHLC…",
      "priceUsd": "0.001",
      "category": "analytics"
    }
  },
  {
    "segment": "flint/external-tape",
    "id": "x402-flint-external-tape",
    "label": "Flint External Tape: Short snapshot of external aggregator fills and venue quotes",
    "method": "GET",
    "params": [],
    "catalogMeta": {
      "segment": "flint/external-tape",
      ...
      "description": "Collects a short-lived stream of external DEX aggregator fills (Jupiter, OKX, DFlow, Titan, …) and per-venue reference quotes for one Flint…",
      "priceUsd": "0.005",
      "category": "analytics"
    }
  },
