...
export const env = {
  ...
  /** Primary RPC; staking reads fall back to public endpoints if this key blocks chain access. */
  solanaRpcUrl: read("VITE_SOLANA_RPC_URL") ?? "https://api.mainnet-beta.solana.com",
