...
export default function InternalTeamAgentsMonitor() {
  ...
  return (
    <div className={DASHBOARD_CONTENT_SHELL}>
      <div className={`${PAGE_PADDING_TOP_MEDIUM} space-y-8`}>
        <InternalAgentsHero
          onRefresh={() => {
            void trendQ.refetch();
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          <AgentOverviewCard
            ...
            href="/internal-team-agents/trend-scout"
          ...
          <AgentOverviewCard
            ...
            href="/internal-team-agents/growth-scout"
          ...
          <AgentOverviewCard
            ...
            href="/internal-team-agents#partnership-board"
