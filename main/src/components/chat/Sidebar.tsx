        ...
        {sessionReady ? (
          <div className="shrink-0 border-t border-border/50 px-2 py-2">
            <button
              ...
              className={cn(
                "flex min-h-[40px] w-full items-center gap-2.5 rounded-lg px-3 text-left text-sm font-medium transition-colors",
                isSettingsActive
            ...
            {[
              ...
              { href: LINK_SYRA_TELEGRAM, icon: Send, label: "Telegram" },
              ...
              <a
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground/80 transition-colors hover:bg-accent/50 hover:text-foreground"
                aria-label={label}
              >
