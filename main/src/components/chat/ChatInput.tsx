...
export const ChatInput = forwardRef<ChatInputHandle, ChatInputProps>(function ChatInput(
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 shrink-0 bg-gradient-to-t from-background from-40% via-background/90 to-transparent pb-[max(0.75rem,env(safe-area-inset-bottom,0))] pt-8">
      <div className="pointer-events-auto mx-auto w-full min-w-0 max-w-3xl px-3 sm:px-4">
        <div
          className={cn(
