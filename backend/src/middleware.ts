...
const WALLET_ADDRESS: any = process.env.PAYTO_ADDRESS || "0xYourWalletAddress";
const NETWORK = process.env.FAREMETER_NETWORKS || "solana-devnet";
const PRICE = process.env.PAYMENT_AMOUNT || "0.01";
const FACILITATOR_URL: any =
  process.env.FAREMETER_FACILITATOR_URL || "https://x402.org/facilitator";
...
export const x402Middleware = paymentMiddleware(
  WALLET_ADDRESS, // Your receiving wallet address
  {
    ...
    "GET /btc-price": {
      ...
      network: NETWORK as any, // 'base-sepolia', 'base', 'solana', 'ethereum'
    },
...
export const logPaymentMiddleware = (
  req: Request,
  res: Response,
  next: NextFunction
) => {
