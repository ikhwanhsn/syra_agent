...
import { lookupKnownSPLToken, x402Exact, xSolanaSettlement, } from "@faremeter/info/solana";
import { Keypair } from "@solana/web3.js";
const { PAYER_KEYPAIR } = process.env;
if (!PAYER_KEYPAIR) {
    throw new Error("PAYER_KEYPAIR must be set in your environment");
}
const payToKeypair = Keypair.fromSecretKey(Uint8Array.from(JSON.parse(PAYER_KEYPAIR)));
