    ...
    <header className="post-studio-header relative z-20 shrink-0 px-3 py-3 sm:px-5 sm:py-4 lg:px-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between lg:gap-4">
        <div className="flex min-w-0 items-start gap-3">
          <PostBackLink
            to="/post"
            className="mt-0.5 rounded-md border-emerald-500/25 bg-emerald-500/[0.06] hover:border-emerald-400/40 hover:bg-emerald-500/10"
          />
          <div className="post-studio-title-block min-w-0 flex-1">
            <div className="flex flex-wrap items-center gap-2">
              <img
                ...
                alt=""
                className="h-8 w-8 shrink-0 rounded-lg border border-emerald-500/25 object-cover ring-1 ring-emerald-500/10"
              />
            ...
            <p className="mt-0.5 font-mono text-[10px] uppercase tracking-[0.14em] text-emerald-400/55">
              {meta.published} · Up Only Fund brief
            </p>
          </div>
        </div>
