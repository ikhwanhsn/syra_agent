...
export function StrategicAnchorSection({ className }: StrategicAnchorSectionProps) {
  return (
    ...
    >
      <blockquote className="landing-institutional-panel relative min-w-0 px-5 py-10 min-[400px]:px-8 min-[400px]:py-12 sm:px-12 sm:py-14 md:px-16 md:py-16">
