...
export function FinalCta({ className }: FinalCtaProps) {
  return (
    ...
    >
      <div className="landing-institutional-panel min-w-0 px-5 py-12 text-center min-[400px]:px-8 min-[400px]:py-14 sm:px-14 sm:py-16 md:px-20 md:py-20">
        ...
        <div className="mt-10 flex w-full min-w-0 flex-col items-stretch justify-center gap-3 min-[400px]:flex-row min-[400px]:items-center md:mt-12">
          <Button
            asChild
            size="lg"
            className="h-12 w-full rounded-md bg-foreground px-8 font-semibold text-background hover:bg-foreground/90 min-[400px]:w-auto min-[400px]:min-w-[13rem]"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="h-12 w-full rounded-md border-border/70 bg-transparent px-8 font-medium hover:bg-foreground/[0.04] min-[400px]:w-auto"
          >
