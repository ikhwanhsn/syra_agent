...
/**
 * Investor brief: Up Only Fund mandate and 80/20 thesis.
...
export const FUND_MANDATE_POST: PostUpdate = {
  meta: {
    ...
    shareCopyVideo: `INVESTOR BRIEF · Up Only Fund mandate is live.
...
Full breakdown in the video ↓`,
    shareCopyPhoto: `INVESTOR BRIEF · Up Only Fund on Solana.
...
Read the mandate at uponlyfund.com`,
  },
  slides: [
    {
      id: "cover",
    ...
    },
    {
      ...
      body: "Retail funds chase narratives. Institutional allocators gate their thesis. Up Only Fund publishes mandate, sleeve criteria, and portfolio disclosures onchain so conviction sizing is visible, not implied.",
    },
    {
      id: "mandate",
      kind: "hero",
