/**
 * Central copy for the institutional fund landing (Solana positioning).
 */

export const FUND_LANDING = {
  brandLine: "Onchain Capital for High Conviction Bets",
  heroEyebrow: "High conviction · onchain",
  heroTitle: "Up Only Fund",
  heroSubtitle:
