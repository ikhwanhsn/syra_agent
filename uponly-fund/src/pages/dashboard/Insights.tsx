...
export default function InsightsPage() {
  ...
  const setActiveTab = (tab: string) => {
    ...
    navigate({ pathname: "/insights", search: query ? `?${query}` : "" }, { replace: true });
  };

  return (
    <TokenGate pageTitle={copy.pages.insightsTitle} preview={<InsightsPreview />}>
      <div className="relative flex flex-col gap-8">
        ...
        <div className="relative z-[1] flex flex-col gap-8">
          <DashboardPageHeader
            eyebrow={copy.pages.insightsEyebrow}
            title={copy.pages.insightsTitle}
            description={copy.pages.insightsDescription}
          />
