  ...
  return (
    <RiseDashboardProvider>
      <div className="relative min-h-dvh w-full min-w-0 max-w-full overflow-x-clip bg-background">
        ...
        <Navbar />
        <main
          className="relative z-10 w-full min-w-0 scroll-mt-16 pt-[max(4.5rem,env(safe-area-inset-top,0px)+3.5rem)] pb-20 sm:pt-24 sm:pb-24 max-sm:pb-[max(5.5rem,calc(4rem+env(safe-area-inset-bottom,0px)))] min-[1024px]:pt-28 min-[1024px]:pb-28"
          id="rise-main"
        >
          ...
          <div
            className={cn("relative flex w-full min-w-0 flex-col gap-10 sm:gap-12", siteShell)}
          >
            <RiseHero />
            <UponlySpotlight />
