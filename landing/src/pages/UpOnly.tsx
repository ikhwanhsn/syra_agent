...
export default function UpOnly() {
  ...
  return (
    ...
    <div className="relative min-h-dvh w-full min-w-0 max-w-full overflow-x-clip bg-background">
      ...
      <Navbar />
      <main
        className="relative z-10 w-full min-w-0 scroll-mt-20 pt-24 sm:pt-28 pb-28 sm:pb-32 max-sm:pb-[max(6.5rem,calc(4.5rem+env(safe-area-inset-bottom,0px)))]"
        id="uponly-main"
      >
        ...
        <div className="relative mx-auto w-full min-w-0 max-w-7xl px-3 max-[360px]:px-2.5 min-[500px]:px-5 sm:px-6 lg:px-8">
          <HeroSection />
          <WhyUpOnly />
