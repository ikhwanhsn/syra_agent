          ...
          {[
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium text-sm sm:text-base transition-all duration-300 relative ${
                activeTab === tab.key
                  ? 'bg-primary text-primary-foreground shadow-[0_0_15px_hsl(var(--ring)/0.2)]'
                ...
                {groupedEvents.active.length > 0 && (
                  <div>
                    <h2 className="text-lg sm:text-xl font-bold mb-3 flex items-center gap-2">
                      <span className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-primary to-ring animate-pulse"></span>
                      Active Events
