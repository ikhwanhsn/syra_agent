...
const HistorySignal = () => {
  ...
  return (
    <div className="bg-white py-2 rounded-md shadow-md min-h-[500px] mt-3 mb-5 max-w-7xl px-4 mx-3 xl:mx-auto">
      <div className="sm:flex items-center justify-between space-y-3 sm:space-x-0">
        <h1 className="text-2xl font-bold text-gray-800">History Signal</h1>
